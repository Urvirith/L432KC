...
void mcp6050_init(I2C_TypeDef *ptr) {
    i2c_std_write(ptr, ADDR_MCP_0, ADDR_7_BIT_ACT, ADDR_7_BIT_ACT, &mcp_wakeup, ADDR_ARRAY);
    i2c_std_write(ptr, ADDR_MCP_0, ADDR_7_BIT_ACT, ADDR_7_BIT_ACT, &mcp_gyro, ADDR_ARRAY);
    i2c_std_write(ptr, ADDR_MCP_0, ADDR_7_BIT_ACT, ADDR_7_BIT_ACT, &mcp_acc, ADDR_ARRAY);
}

void mcp6050_read_gyro(I2C_TypeDef *ptr, uint8_t *buf, uint32_t len) {
    i2c_std_read(ptr, ADDR_MCP_0, ADDR_7_BIT_ACT, ADDR_7_BIT_ACT, &mcp_gyro_reg, REG_ARRAY, buf, len);
}

void mcp6050_read_accel(I2C_TypeDef *ptr, uint8_t *buf, uint32_t len) {
    i2c_std_read(ptr, ADDR_MCP_0, ADDR_7_BIT_ACT, ADDR_7_BIT_ACT, &mcp_acc_reg, REG_ARRAY, buf, len);
}

void mcp6050_read_temp(I2C_TypeDef *ptr, uint8_t *buf, uint32_t len) {
    i2c_std_read(ptr, ADDR_MCP_0, ADDR_7_BIT_ACT, ADDR_7_BIT_ACT, &mcp_temp_reg, REG_ARRAY, buf, len);
}
